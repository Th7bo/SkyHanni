...
object EasterEggs {
    ...
    private val chompsSound by lazy { SoundUtils.createSound("skyhanni:easteregg.chomps", 1f, 2f, isWarning = false) }
    private val holyAssSound by lazy { SoundUtils.createSound("skyhanni:easteregg.holyass", 1f, 10f, isWarning = false) }
