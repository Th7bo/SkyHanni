...
enum class OreBlock(
    ...
    // MITHRIL
    LOW_TIER_MITHRIL({ isLowTierMithril(it) }, { inDwarvenMines || inGlacite }, OreCategory.DWARVEN_METAL, hasInitSound = false),
    MID_TIER_MITHRIL(
        { isMidTierMithril(it) },
        { inDwarvenMines || inCrystalHollows || inGlacite },
        OreCategory.DWARVEN_METAL,
        hasInitSound = false,
    ),
    HIGH_TIER_MITHRIL(
        { isHighTierMithril(it) },
        { inDwarvenMines || inCrystalHollows || inGlacite },
        OreCategory.DWARVEN_METAL,
        hasInitSound = false,
    ),
